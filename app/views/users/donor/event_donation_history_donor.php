  ...
  <body>
    ...
    <section class="home-section">
      ...
      <div class="main-container">
            ...
            <?php foreach($data['details'] as $record) : ?>
              
                <div class="cards_heading4 cards_color">
                <div><?php echo $record->time_stamp; ?></div>
                <div><?php echo $record->event_title; ?></div>
                <div><?php echo $record->location; ?></div>
                <div><?php echo $record->donor_name; ?></div>
                <div>Rs.<?php echo $record->amount; ?></div>
                <div><?php 
